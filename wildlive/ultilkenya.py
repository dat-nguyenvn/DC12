                ...
                if is_not_box_at_edge(box_yolo):
                    ...
                    for index,p in enumerate (points_list):
                        ...
                        if mask.contains(shapely_point) and tracking_list[index]!=value:
                            #remove_list.append(index) # +history point +50
                            history_point[index]+=step_jump_point_notin_mask #point not in mask + 50 history 
                        elif mask.contains(shapely_point) and tracking_list[index]==value:
                            #history = 0
                            history_point[index]=0
                        # else: 
                        #     history_point(index)+=1
...
def filter_dict_main_overlap_box(bbox_dict, iou_threshold=0.8,iou_threshold_modify=0.8):
    """
