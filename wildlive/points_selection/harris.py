...
class harris_selection_method(selected_point_method):
    def process(self, cropped_image_numpy, blockSize=5, ksize=3, k=0.04, threshold=0.2):
        try:
            ...
            if cropped_image_numpy is None or cropped_image_numpy.size == 0:
            ...
            print(f"ValueError in process: {ve}")
        except cv2.error as e:
            print(f"OpenCV error in process: {e}")
        except Exception as e:
            print(f"Unexpected error in process: {e}")
