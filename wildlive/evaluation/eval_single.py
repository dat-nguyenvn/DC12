...
def evaluate_mot(gt_path, tracker_path, tracker_name, results_list):
    ...
    for frame_id in sorted(gt['FrameId'].unique()):
        ...
        distances = mm.distances.iou_matrix(gt_boxes, tr_boxes, max_iou=0.9)#0.9 is correct
...
gt_path='/home/ah23975/mypc/2025/github/DC12/demo_data/eval/GT_MOT/DJI_small.csv'
tracker_path='/home/ah23975/mypc/2025/github/DC12/demo_data/DJI_small.csv'
evaluate_mot(gt_path,tracker_path,'wildlive',[])
