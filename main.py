...
#video_name='vlc-record-2025-01-03-14h37m50s-DJI_20240624153820_0001_V'
...
result_main=init_detection(rgb_image, sahimodel)
...
list_dict_info_main=process_boxes_complete_step_init(list_dict_info_main,id_list_intrack,trackpoint_list_tuple,w,h)
...
while True:
    ...
    print("window_detection", len(window_detection))
    ...
    for m in range (0,n_window):
        ...
        if out_detector[0].masks!=None:
            ...
            #box_id2=matching_module().matching2(box_id,id_list_intrack,out_detector,center_crop[m],curFeatures.cpu(),threshold_ecl_dis_match=ecl_dis_match)
...
average = length_run/elapsed_time
