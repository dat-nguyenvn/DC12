...
def init_detection(input_path):
    ...
    yolov8_seg_model_path = "yolov8s-seg.pt"
...
#     x1_1, y1_1 = box1[0] - box1[2] / 2, box1[1] - box1[3] / 2  # Top-left corner of box1
#     x2_1, y2_1 = box1[0] + box1[2] / 2, box1[1] + box1[3] / 2  # Bottom-right corner of box1
    
#     x1_2, y1_2 = box2[0] - box2[2] / 2, box2[1] - box2[3] / 2  # Top-left corner of box2
#     x2_2, y2_2 = box2[0] + box2[2] / 2, box2[1] + box2[3] / 2  # Bottom-right corner of box2
...
# def find_new_point_on_full_frame(np_box,window_center,window_size,box_center):
#     window_center_x,window_center_y=window_center
#     top_left_window_x= window_center_x - window_size/2
#     top_left_window_y= window_center_y - window_size/2
#     find_new_point_on_box=harris_selection_method().filter_some_points(np_box,polygon,top_left_window_x,top_left_window_y)
#     convert_point_box_to_window
#     convert_point_window_to_full_frame
#     return None
...
# def checking(list_dict_info_main,):
